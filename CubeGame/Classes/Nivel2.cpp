...
void Nivel2::crearEscenaIntermedia() {
    ...
    Vec2 origin = Director::getInstance()->getVisibleOrigin();
    //Sprite del fondo
        _spriteFondoIntermedio = Sprite::create("PantallasIntermedias/Nivel2.png");
    ...
    //Enemigo
        //Circulo
            ...
            cacher1->addSpriteFramesWithFile("Cache2.plist");
            ...
            circuloIntermedio->setPosition(Point((visibleSize.width / 2) - 40, 255));
        ...
        //Triangulo
            ...
            trianguloIntermedio->setPosition(Point((visibleSize.width / 2) - 40, 205));
    ...
    //Boton PlayIntermedio
        botonPlayIntermedio = MenuItemImage::create("ImagenesMenu/PlayBoton.png", "ImagenesMenu/PlayBotonS.png", CC_CALLBACK_1(Nivel2::PlayIntermedio, this));
...
void Nivel2::crearEscenaIntermediaFinal() {
    ...
    //Boton PlayIntermedioFinal
        botonPlayIntermedioFinal = MenuItemImage::create("ImagenesMenu/PlayBoton.png", "ImagenesMenu/PlayBotonS.png", CC_CALLBACK_1(Nivel2::PlayIntermedioFinal, this));
...
void Nivel2::crearEscenaDerrota() {
    ...
    //Boton Derrota
        botonMenuDerrota = MenuItemImage::create("ImagenesMenu/BackMenu.png", "ImagenesMenu/BackMenuS.png", CC_CALLBACK_1(Nivel2::MenuDerrota, this));
...
void Nivel2::crearEscena() {
    ...
    //Boton Configuracion
        botonConfiguracion = MenuItemImage::create("HUD/Tuerca.png", "HUD/TuercaPush.png", CC_CALLBACK_1(Nivel2::ConfigurationButton, this));
    ...
    //Sprite del fondo
        auto spriteFondo = Sprite::create("Nivel2/Montanas.png");
    ...
    //Nivel
        ...
        auto estrellaNivel1 = Sprite::create("EstrellasNivel/EstrellaPlata.png");
        estrellaNivel1->setScale(0.2, 0.2);
        estrellaNivel1->setPosition(Point(399, 69));
        this->addChild(estrellaNivel1, 100);
    ...
    //Enemigos
        this->schedule(SEL_SCHEDULE(&Nivel2::agregarEnemigos), 3);

    //Nubes
        this->schedule(SEL_SCHEDULE(&Nivel2::agregarNubes), 3);
    ...
    //Audio
        _musicaFondoNivel1 = AudioEngine::play2d("Audios/MusicaFondoNivel2.mp3", true, _volumenMusica);
...
void Nivel2::iniciarFisicaCubito(Sprite* sprite, int n) {
...
void Nivel2::iniciarFisicaCirculos(Sprite* sprite, int n) {
    ...
    _enemigosBody[contEnemigosBody]->setVelocity(Vec2(cocos2d::random(0, 0),
        cocos2d::random(-100, -80)));
    sprite->addComponent(_enemigosBody[contEnemigosBody]);
    contEnemigosBody += 1;

}

void Nivel2::iniciarFisicaTriangulos(Sprite* sprite, int n) {
    auto dn = new Vec2[3]();
...
void Nivel2::agregarCubitoNormal() {
    ...
    cacher->addSpriteFramesWithFile("Cache2.plist");
...
void Nivel2::agregarLuna() {
    ...
    _luna = Sprite::createWithSpriteFrameName("Luna1.png");
...
void Nivel2::moverNubes(Sprite* sprite) {
    auto visibleSize = Director::getInstance()->getVisibleSize();
    sprite->runAction(
        Sequence::create(
...
void Nivel2::agregarNube1() {
    ...
    {
        std::stringstream ss;
        ss << "NubesNocheA" << i << ".png";
        frames.pushBack(cacher1->getSpriteFrameByName(ss.str()));
    }

    _nubes[contNubes] = Sprite::createWithSpriteFrameName("NubesNocheA1.png");
...
void Nivel2::agregarNube2() {
    ...
    {
        std::stringstream ss;
        ss << "NubesNocheB" << i << ".png";
        frames.pushBack(cacher->getSpriteFrameByName(ss.str()));
    }

    _nubes[contNubes] = Sprite::createWithSpriteFrameName("NubesNocheB1.png");
    _nubes[contNubes]->setTag(tagNum);
    tagNum += 1;
    this->addChild(_nubes[contNubes], 3);
...
void Nivel2::agregarNube3() {
    ...
    {
        std::stringstream ss;
        ss << "NubesNocheC" << i << ".png";
        frames.pushBack(cacher->getSpriteFrameByName(ss.str()));
    }

    _nubes[contNubes] = Sprite::createWithSpriteFrameName("NubesNocheC1.png");
    _nubes[contNubes]->setTag(tagNum);
    tagNum += 1;
    this->addChild(_nubes[contNubes], 3);
...
void Nivel2::agregarNube4() {
    ...
    {
        std::stringstream ss;
        ss << "NubesNocheD" << i << ".png";
        frames.pushBack(cacher->getSpriteFrameByName(ss.str()));
    }

    _nubes[contNubes] = Sprite::createWithSpriteFrameName("NubesNocheD1.png");
    _nubes[contNubes]->setTag(tagNum);
    tagNum += 1;
    this->addChild(_nubes[contNubes], 3);
...
void Nivel2::ConfigurationButton(Nivel2::Ref* pSender) {
    auto visibleSize = Director::getInstance()->getVisibleSize();
    CCLOG("Configuracion");
    ...
    //AgregarBotones
    botonContinue = MenuItemImage::create("ImagenesMenu/ContinueBoton.png", "ImagenesMenu/ContinueBotonS.png", CC_CALLBACK_1(Nivel2::ContinueButton, this));
    botonHighsScore = MenuItemImage::create("ImagenesMenu/HighScoreBoton.png", "ImagenesMenu/HighScoreBotonS.png", CC_CALLBACK_1(Nivel2::HighsScoreButton, this));
    botonMenu = MenuItemImage::create("ImagenesMenu/BackMenu.png", "ImagenesMenu/BackMenuS.png", CC_CALLBACK_1(Nivel2::MenuButton, this));
    botonClose = MenuItemImage::create("ImagenesMenu/CloseBoton.png", "ImagenesMenu/CloseBotonS.png", CC_CALLBACK_1(Nivel2::CloseButton, this));
...
void Nivel2::ContinueButton(Nivel2::Ref* pSender) {
...
void Nivel2::HighsScoreButton(Nivel2::Ref* pSender) {
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    this->removeChild(_menuPausa);
    this->removeChild(botonContinue);
    this->removeChild(botonHighsScore);
    ...
    //Boton
    botonCloseHigh = MenuItemImage::create("ImagenesMenu/CloseBoton.png", "ImagenesMenu/CloseBotonS.png", CC_CALLBACK_1(Nivel2::CloseButtonHigh, this));
...
void Nivel2::MenuButton(Nivel2::Ref* pSender) {
    Director::getInstance()->resume();
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    auto visibleSize = Director::getInstance()->getVisibleSize();
    CCLOG("Menu");
...
void Nivel2::CloseButton(Nivel2::Ref* pSender) {
    Director::getInstance()->resume();
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    auto visibleSize = Director::getInstance()->getVisibleSize();
    CCLOG("Close");
...
void Nivel2::CloseButtonHigh(Nivel2::Ref* pSender) {
    Director::getInstance()->resume();
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Nivel2::PlayIntermedio(Nivel2::Ref* pSender) {
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Nivel2::PlayIntermedioFinal(Nivel2::Ref* pSender) {
    auto visibleSize = Director::getInstance()->getVisibleSize();
    CCLOG("PlayIntermedioFinal");
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    this->removeAllChildren();
    auto menuPrincipal = Nivel3::createScene();
    Director::getInstance()->replaceScene(TransitionFade::create(0.5, menuPrincipal));
}

void Nivel2::MenuDerrota(Nivel2::Ref* pSender) {
    _efectoSeleccionar = AudioEngine::play2d("Audios/EfectoSeleccionar.mp3", false, _volumenSeleccionar);
    auto visibleSize = Director::getInstance()->getVisibleSize();
    CCLOG("MenuDerrota");
    AudioEngine::stop(_musicaFondoNivel1);
